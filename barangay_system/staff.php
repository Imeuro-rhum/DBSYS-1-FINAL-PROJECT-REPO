...
$staff = $conn->query("SELECT * FROM barangay_staff ORDER BY last_name");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Staff - Barangay System</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="bi bi-person-badge"></i> Barangay Staff</h1>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="staff_add.php?edit=<?php echo $row['staff_id']; ?>" 
